...
#define SURPRISE_CANNON 12
#define SURPRISE_LIFE 12
#define SURPRISE_EYE 7

#define SURPRISES_SUM (SURPRISE_SCREW+SURPRISE_KEY+SURPRISE_SMOKE+SURPRISE_SURPRISE+SURPRISE_AMMO+SURPRISE_BOMB+SURPRISE_EXIT+SURPRISE_CANNON+SURPRISE_LIFE+SURPRISE_EYE)