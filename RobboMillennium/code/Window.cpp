...
{
    AddTexture(MENU_TLO, "../images/menu/menu.bmp");
    AddTexture(PRZYCISK_GRA, "../images/menu/przyciskGra.bmp");
    AddTexture(PRZYCISK_GRA_AKTYWNY, "../images/menu/przyciskGraAktywny.bmp");
    AddTexture(PRZYCISK_WYJSCIE, "../images/menu/przyciskWyjscie.bmp");
    AddTexture(PRZYCISK_WYJSCIE_AKTYWNY, "../images/menu/przyciskWyjscieAktywny.bmp");
    AddTexture(LEVEL_FLOOR, "../images/level/pole.bmp");
    AddTexture(LEVEL_ROBBO, "../images/level/robbo.bmp");
    AddTexture(LEVEL_WALL, "../images/level/sciana.bmp");
    AddTexture(LEVEL_CHEST, "../images/level/skrzynia.bmp");
}